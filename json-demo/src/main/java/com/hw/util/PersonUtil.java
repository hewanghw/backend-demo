...
public class PersonUtil {
    ...
    private static final String[] FAMILY_NAMES = (
                    "赵,钱,孙,李,周,吴,郑,王,冯,陈,褚,卫,蒋,沈,韩,杨,朱,秦,尤,许,何,吕,施,张"
                            + "孔,曹,严,华,金,魏,陶,姜," + "戚,谢,邹,喻,柏,水,章," + "云,苏,潘,葛,奚,范,彭,"
                            + "鲁,韦,昌,马,苗,凤,花,方," + "俞,任,袁,柳,酆,鲍,史,唐"
                    ).split(",");
    // 常用名
    private static final String[] MALE_NAMES = (
                    "伟,强,磊,军,勇,杰,峰,超,波,斌,宇,浩,凯,鹏,亮,俊,威,辉,雷,洋,武,敖,阳,海,轩,浩,宇,易,昊,志,龙," +
                    "宇,晨,瑞,豪,震,贺,斌,明华,子健,涛鑫,志远,瑞昌,泽宇,晓东,健豪,俊杰,建军,泽宇,启强,鑫磊,明杰,翔宇," +
    ...
    private static final String[] FEMALE_NAMES =(
                    "芳,娜,敏,静,秀,磊,丽,艳,婷,欣,倩,霞,慧,莹,艺,婉,娇,媛,玲,洁,梦,汀,芸,丽,敏,雪,蕾,怡,美,蓉,艳," +
                    "艾,欣,莉,涵,琳,静,晨,琪,娟,佳,露,菲,欢,妙彤,如萱,亦瑶,欣怡,晓敏,欣怡,慧娟,思婷,晓敏,静雅,美玲," +
                    "梦雨," +
    ...
    {{
        ...
        put("21", "辽宁省");put("22", "吉林省");put("23", "黑龙江省");put("31", "上海市");put("32", "江苏省");
        put("33", "浙江省");put("34", "安徽省");put("35", "福建省");put("36", "江西省");put("37", "山东省");
        put("41", "河南省");put("42", "湖北省");put("43", "湖南省");put("44","广东省");put("45", "广西壮族自治区");
        put("46", "海南省");put("50", "重庆市");put("51", "四川省");put("52", "贵州省");put("53","云南省");
        put("54", "西藏自治区");put("61", "陕西省");put("62", "甘肃省");put("63", "青海省");
        put("64", "宁夏回族自治区");put("65", "新疆维吾尔族自治区");
     ...
     * @return
     */
    public static String randomProvinceCode(){
        Set<String> keySet = PROVINCE_CODE_MAP.keySet();
        String[] provinceCodes = keySet.toArray(new String[0]);
    ...
    /**
     * 根据省（自治区、直辖市）行政区划代码生成身份证号
     * 身份证号由17位数字本体码和1位校验码组成。
     * 排列顺序从左至右依次为：6位数字地址码，8位数字出生日期码，3位数字顺序码和1位数字校验码。
     * 第17位表示性别，男性为单数，女性为双数。第18位为校验码。
     */
    public static String randomId(String provinceCode){
        // 根据省（自治区、直辖市）行政区划代码生成完整地址代码，比如37 -> 372922
        String addressCode = provinceCode + String.format("%04d", random.nextInt(10000));
        // 出生日期
        LocalDate localDate = DateUtil.randomDateBetween(1990, 2003, 1, 12, 1, 28);
        String birthDate = localDate.format(DateTimeFormatter.ofPattern("yyyyMMdd"));
        // 顺序吗
        String sequenceCode = String.format("%03d", random.nextInt(1000));
        // 校验码
        String[] checkCodes = {"1", "0", "X", "9", "8", "7", "6", "5", "4", "3", "2"};
        String id = addressCode + birthDate + sequenceCode;
        ...
        int index = sum % 11;
        char checkCode = checkCodes[index].charAt(0);
        return id + checkCode;
    }
